...
class DesktopController extends Controller
{
    ...
    public function index(Request $request){
        ...
        return view('desktop.home', compact('Menu','Category','Orders'));
    }
    ...
    public function add_to_cart_get($id)
    {
        ...
        return view('desktop.checkout', compact('cartItems'));
    }
    ...
    public function orders(){
        ...
        return view('desktop.orders', compact('Order'));
    }
    ...
    public function orders_details($id){
        ...
        return view('desktop.orders-details', compact('Order', 'OrderProducts'));
    }
    ...
    public function transactions(){
        ...
        return view('desktop.transactions', compact('lnmo_api_response'));
    }


    public function edit_profile(){
        return view('desktop.edit-profile');
    }

    public function profile(){
        return view('desktop.profile');
    }

    public function offers(){
        return view('desktop.offers');
    }

    public function veryfy_number(){
        return view('desktop.veryfy-number');
    }

    public function verification_code(){
        return view('desktop.verification-code');
    }

    public function search(){
        $Category = DB::table('category')->get();
        $Menu = DB::table('menus')->where('title','0')->get();
        return view('desktop.search', compact('Menu','Category'));
    }

    public function food(){
        $Menu = DB::table('menus')->get();
        return view('desktop.food', compact('Menu'));
    ...
    public function shopping_cart(){
        ...
        return view('desktop.shopping-cart', compact('cartItems'));
    }
    ...
    public function menu($menu){
        ...
        return view('desktop.details', compact('Menu'));
    }

    public function menus(){
        $Menu = DB::table('menus')->get();
        return view('desktop.menu', compact('Menu'));
    }
    ...
    public function category($menu){
        ...
        return view('desktop.menu', compact('Menu','Products'));
    }

    public function menu_item($menu){
        $Products = DB::table('menus')->where('id', $menu)->get();
        return view('desktop.details', compact('Products'));
    }
    ...
    public function location(Request $request)
    {
        ...
        return view('desktop.location', compact('currentUserInfo'));
    }
    ...
    public function edit_profile_pic(){
        ...
        return view('desktop.edit-profile-pic', compact('User'));
    }
    ...
    public function edit_profile_post(Request $request){
        $updateDetails = array(
         ...
         DB::table('users')->where('id', Auth::User()->id)->update($updateDetails);
         $User = User::find(Auth::User()->id);
         return view('desktop.edit-profile', compact('User'));
    }
    ...
    public function search_menu(Request $request){
        ...
        return view('desktop.search', compact('Menu'));
    }
